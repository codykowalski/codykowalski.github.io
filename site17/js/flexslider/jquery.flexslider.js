...
;(function ($) {
  ...
  $.flexslider = function(el, options) {
    ...
    methods = {
      ...
      directionNav: {
        setup: function() {
          var directionNavScaffold = $('<ul class="' + namespace + 'direction-nav"><li><a class="' + namespace + 'prev" href="#"><span class="arrow-left"></span></a></li><li><a class="' + namespace + 'next" href="#"><span class="arrow-right"></span></a></li></ul>');
